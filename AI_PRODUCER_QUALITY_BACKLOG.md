...
| P2 | Add rendered-frame subtitle styling/synchronization inspection. | Current subtitle score is explicitly a transcript-coverage proxy; it cannot evaluate typography or burn-in alignment. |
