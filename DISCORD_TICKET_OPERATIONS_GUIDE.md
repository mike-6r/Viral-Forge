...
Topics include General, Workspace Setup, Source Setup, Publishing Issue, Account Access, Billing, Custom Workflow, Bug Report, and Feature Request. SLA defaults, departments, and response macros live under `config/discord/`.
